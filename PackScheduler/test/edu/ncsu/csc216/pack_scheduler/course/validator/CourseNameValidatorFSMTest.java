 ...
 * course name validator for the FSM
 * @author alexaksland
 *
 */
public class CourseNameValidatorFSMTest {
	...
	/**
	 * Tests the CourseNameValidatorFSM to ensure that the FSM returns the correct
	 * T/F for whether a given course name is valid
	 * 
	 ...
	 */
	@Test
	public void testCourseNameValidatorFSM() throws InvalidTransitionException {
